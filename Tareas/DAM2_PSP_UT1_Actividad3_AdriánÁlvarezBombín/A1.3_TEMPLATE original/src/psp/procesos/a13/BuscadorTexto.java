...
/**
 * Clase que representa la interfaz gráfica para la búsqueda de texto
 * Muestra los campos para introducir la opción de búsqueda y el fichero
 *
 * @author Adrián Álvarez Bombím
 * @version 1.0
 */
public class BuscadorTexto extends JFrame {
    ...
    /**
     * Método para realizar la búsqueda de texto (implementación básica)
     * @param opcionBuscar Texto a buscar
     * @param idFichero Identificador del fichero donde buscar
     */
